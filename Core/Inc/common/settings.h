...
#define CONFIG_ROLL_ANGLE_D_LPF_CUTOFF_FREQ_RPS		2 * PI * 75.0f
#define CONFIG_ROLL_ANGLE_CMD_LIM					CONFIG_ROLL_MAX_DPS
#define CONFIG_ROLL_ANGLE_I_CMD_LIM					CONFIG_ROLL_ANGLE_CMD_LIM * 0.3

#define CONFIG_PITCH_ANGLE_P_GAIN					11.5f
#define CONFIG_PITCH_ANGLE_I_GAIN					11.0f
#define CONFIG_PITCH_ANGLE_D_GAIN					0.85f
#define CONFIG_PITCH_ANGLE_D_LPF_CUTOFF_FREQ_RPS	2 * PI * 75.0f
#define CONFIG_PITCH_ANGLE_CMD_LIM					CONFIG_PITCH_MAX_DPS
#define CONFIG_PITCH_ANGLE_I_CMD_LIM				CONFIG_PITCH_ANGLE_CMD_LIM * 0.3

#define CONFIG_ROLL_RATE_P_GAIN						7.5f
#define CONFIG_ROLL_RATE_I_GAIN						5.5f
#define CONFIG_ROLL_RATE_D_GAIN						0.0f
#define CONFIG_ROLL_RATE_D_LPF_CUTOFF_FREQ_RPS		2 * PI * 75.0f
#define CONFIG_ROLL_RATE_CMD_LIM					150.0f
#define CONFIG_ROLL_RATE_I_CMD_LIM					CONFIG_ROLL_RATE_CMD_LIM * 0.3

#define CONFIG_PITCH_RATE_P_GAIN					7.5f
#define CONFIG_PITCH_RATE_I_GAIN					5.5f
#define CONFIG_PITCH_RATE_D_GAIN					0.0f
#define CONFIG_PITCH_RATE_D_LPF_CUTOFF_FREQ_RPS		2 * PI * 75.0f
#define CONFIG_PITCH_RATE_CMD_LIM					150.0f
#define CONFIG_PITCH_RATE_I_CMD_LIM					CONFIG_PITCH_RATE_CMD_LIM * 0.3

#define CONFIG_YAW_RATE_P_GAIN						7.5f
#define CONFIG_YAW_RATE_I_GAIN						5.5f
#define CONFIG_YAW_RATE_D_GAIN						0.0f
#define CONFIG_YAW_RATE_D_LPF_CUTOFF_FREQ_RPS		2 * PI * 75.0f
#define CONFIG_YAW_RATE_CMD_LIM						150.0f
#define CONFIG_YAW_RATE_I_CMD_LIM					CONFIG_YAW_RATE_CMD_LIM * 0.3
